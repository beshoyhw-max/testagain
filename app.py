...
# --- Page 3: Face Recognition ---
    ...
    try:
        ...
        with tab4:
            ...
            current_threshold = recognizer.threshold
            ...
            if st.button("Update Threshold"):
                recognizer.update_threshold(new_threshold)
            ...
            face_rec_enabled = st.checkbox(
                ...
                help="Note: Requires camera restart to take effect"
            )
            
            if face_rec_enabled != manager.global_face_recognition:
                manager.enable_face_recognition(face_rec_enabled)
                st.warning("⚠️ Face recognition setting changed. Please restart cameras in Configuration tab.")
