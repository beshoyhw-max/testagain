...
class FaceRecognizer:
    def __init__(self, 
        ...
        """
        FINAL FIX: Proper YuNet detector usage for real-time recognition.
        """
    ...
    def recognize_face(self, frame, bbox):
        """
        FIXED: Optimized for real-time recognition.
        """
        ...
        if len(faces) == 0:
            # No face in ROI - this is expected if person is far/turned away
            return "Unknown", 0.0
    ...
    def update_threshold(self, new_threshold):
        ...
        print(f"Recognition threshold updated to {self.threshold}")
