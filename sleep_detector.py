...
class SleepDetector:
    def __init__(self, pose_model_path='yolo26n-pose.pt', 
        ...
        # REMOVED: Internal timing - detector.py now handles all timing
        ...
        if run_mediapipe:
            try:
                ...
                if detection_result.face_landmarks:
                    ...
                    # SIMPLIFIED: Return state immediately, detector.py handles timing
                    if avg_ear < current_threshold:
                        # Eyes are closed - return drowsy (detector.py tracks duration)
                        return "drowsy", {
                            "ear": avg_ear, 
                            "still": is_head_still, 
                            "source": "mediapipe",
